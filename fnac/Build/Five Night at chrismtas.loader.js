function createUnityInstance(t, n, c) {
    ...
    var d, u, h, f, p, m, g, b, v, w = "", y = "", S = (document.addEventListener("webkitfullscreenchange", function(e) {
    ...
    function(o, a) {
        var e, t, i = g.getInstance(), s = E("string" == typeof o ? o : o.url), c = {
            enabled: (e = s,
        ...
        function d(n, r) {
            return fetch(n, r).then(function(e) {
                ...
                v(c.response, r.onProgress, r.enableStreamingDownload)) : 200 == e.status ? (c.response = e,
        ...
        c.enabled ? i.loadRequest(s).then(function(e) {
            ...
            v(n, a.onProgress, a.enableStreamingDownload)) : (e = s,
